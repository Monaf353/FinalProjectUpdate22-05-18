...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    private MaterialEditText mPhoneNumberField;
    private MaterialEditText mNameField;
    private MaterialEditText mPasswordField;

    private MaterialEditText mVerificationField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhoneNumberField = (MaterialEditText) findViewById(R.id.field_phone_number);
        mNameField = (MaterialEditText)findViewById(R.id.field_name);
        mPasswordField = (MaterialEditText)findViewById(R.id.field_password);

        mVerificationField = (MaterialEditText) findViewById(R.id.field_verification_code);
        ...
        btnSelectBirthday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(PhoneAuthActivity.this,
                            ...
                            myRef.child(userPhone).addListenerForSingleValueEvent(new ValueEventListener()
                            {
                                ...
                                public void onDataChange(DataSnapshot snapshot) {
                                    if (snapshot.getValue() != null) {
                                        ...
                                        //myRef.child("User").setValue("true");




                                        User user1 = new User();
                                        user1.setName(mNameField.getText().toString());
                                        user1.setPassword(mPasswordField.getText().toString());
                                        user1.setBalance(String.valueOf(0.0));
                                        user1.setPhone(contactno);
                                        user1.setBirthday(birthday);
                                        myRef.child(userPhone).setValue(user1);
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            case STATE_INITIALIZED:
                ...
                enableViews(mStartButton, mPhoneNumberField,mNameField,mPasswordField,birthdayLayout);
                disableViews(mVerifyButton, mResendButton, mVerificationField);
                break;
            case STATE_CODE_SENT:
                // Code sent state, show the verification field, the
                enableViews(mVerifyButton, mResendButton, mPhoneNumberField, mVerificationField);
                disableViews(mStartButton,mNameField,mPasswordField,birthdayLayout);
                //  mDetailText.setText(R.string.status_code_sent);
                Toast.makeText(PhoneAuthActivity.this, "code sent", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_FAILED:
                // Verification has failed, show all options
                enableViews(mStartButton, mVerifyButton, mResendButton, mPhoneNumberField, mVerificationField,birthdayLayout);
                //  mDetailText.setText(R.string.status_verification_failed);
                Toast.makeText(PhoneAuthActivity.this, "verification failed", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_SUCCESS:
                // Verification has succeeded, proceed to firebase sign in
                disableViews(mStartButton, mVerifyButton, mResendButton, mPhoneNumberField,mNameField, mVerificationField,birthdayLayout);
