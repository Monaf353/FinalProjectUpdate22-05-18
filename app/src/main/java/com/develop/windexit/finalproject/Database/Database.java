...
public class Database extends SQLiteAssetHelper {
    ...
    public void addToFavorites(Favorites food) {
        SQLiteDatabase db = getReadableDatabase();
        String query = String.format("INSERT INTO Favorites(FoodId,FoodName,FoodPrice,FoodMenuId,FoodImage,FoodDiscount,FoodDescription,Available,UserPhone) " +
    ...
    public List<Favorites> getAllFavorites(String userPhone) {
        ...
        SQLiteDatabase db = getReadableDatabase();
        SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
        String[] sqlSelect = {"UserPhone", "FoodId", "FoodName", "FoodPrice", "FoodMenuId", "FoodImage", "FoodDiscount","Available","FoodDescription"};
        ...
        if (c.moveToFirst()) {
            do {
                result.add(new Favorites(
                        ...
                        c.getString(c.getColumnIndex("Available")),
                        c.getString(c.getColumnIndex("UserPhone"))
    ...
    public void cleanFavorites( String userPhone) {
        SQLiteDatabase db = getReadableDatabase();
        String query = String.format("DELETE FROM Favorites WHERE UserPhone='%s'",userPhone);
        db.execSQL(query);
    }
